...
var displayMap = exports.displayMap = function displayMap(mapEl) {
  ...
  mapboxgl.accessToken = "pk.eyJ1IjoiY29kZS12ZXJzYSIsImEiOiJjbWp5YmpraHo1bHZyM2RzNTVtMW9tNHgwIn0.tfNyreQP33ZjpXtTFMAsyA";
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 20
    }).setLngLat(loc.coordinates).setHTML("<p class=\"mapbox-popup\">Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map);
